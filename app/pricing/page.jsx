...
function PlanCard({ plan }) {
  return (
    <article
      className={`relative flex h-full flex-col rounded-3xl bg-white p-8 shadow-xl ${
        plan.popular
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 md:py-28">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-300">
              Choose a NorthSky Auto dealer plan and access seller-submitted
              vehicle opportunities through your dealer dashboard.
            </p>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 leading-7 text-slate-600">
              NorthSky Auto keeps the dealer onboarding process simple.
            </p>
          </div>
            ...
            {[
              {
                number: "01",
                title: "Choose a plan",
                text: "Select Starter or Professional based on your dealership's sourcing needs.",
              },
              {
                number: "02",
                title: "Create your account",
                text: "Complete your dealer registration and dealership information.",
              },
              {
                number: "03",
                title: "Access the platform",
                text: "Complete secure Stripe subscription checkout and access your dealer tools.",
              },
            ].map((step) => (
              <div
                key={step.number}
      ...
      <section className="px-6 py-20 md:py-24">
        <div className="mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <p className="mt-4 leading-7 text-slate-600">
              Manage vehicle opportunities from one centralized dealer
              workspace.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-12 overflow-hidden rounded-3xl shadow-sm ring-1 ring-slate-200">
            <div className="grid grid-cols-3 border-b border-slate-200 bg-slate-50">
              <div className="p-5 text-sm font-black">Feature</div>
            ...
            {comparison.map(([feature, starter, professional]) => (
              <div
                key={feature}
      ...
      <section className="bg-blue-600 px-6 py-20 text-white md:py-24">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-blue-100">
            Choose your dealer plan and begin your NorthSky Auto onboarding.
          </p>
      ...
      <footer className="bg-slate-950 px-6 py-10 text-slate-400">
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-5 text-sm md:flex-row">
          <div className="text-center md:text-left">
            <p className="font-black text-white">NorthSky Auto</p>
