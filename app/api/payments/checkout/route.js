...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "Dealer Professional includes everything in Dealer Starter plus priority vehicle opportunities, advanced lead management, dealer analytics, pipeline tracking, and priority support.",
  },
  {
      ...
      <section className="px-6 py-20 md:py-28">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8 rounded-2xl border border-slate-200 bg-white p-5 text-center text-sm text-slate-500">
            All prices are in{" "}
            <strong className="text-slate-900">CAD</strong> and billed
            monthly. Subscription access is subject to NorthSky Auto's dealer
            terms.
          </div>
        </div>
      </section>
