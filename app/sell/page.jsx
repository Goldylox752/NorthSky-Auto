...
export const metadata = {
  ...
  description:
    "Submit your vehicle to NorthSky Auto and connect with Canadian dealers looking for inventory. Simple submission, dealer exposure, no obligation.",
};
  ...
  return (
    <div className="bg-white text-slate-900">
        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 sm:py-24 lg:px-8 lg:py-28">
          <div className="grid items-center gap-16 lg:grid-cols-[1.1fr_0.9fr]">
            <div className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-slate-300 backdrop-blur">
                <span className="h-2 w-2 rounded-full bg-emerald-400" />
                Built for the Canadian automotive market
              </div>

              <h1 className="mt-7 text-5xl font-extrabold leading-[1.05] tracking-tight sm:text-6xl lg:text-7xl">
                Your vehicle.
                <br />
              ...
              <p className="mt-7 max-w-2xl text-lg leading-relaxed text-slate-300 sm:text-xl">
                ...
                across Canada. Submit your vehicle and put your opportunity in
                front of businesses looking for their next acquisition.
              </p>
              ...
              <div className="mt-9 flex flex-col gap-3 sm:flex-row">
                ...
                <Link
                  href="/dealer"
                  className="rounded-xl border border-white/15 bg-white/5 px-7 py-4 text-center font-semibold text-white transition hover:bg-white/10"
                >
                  I&apos;m a Dealer
                </Link>
              </div>

              <div className="mt-8 flex flex-wrap gap-x-7 gap-y-2 text-sm text-slate-400">
                ...
                <div className="rounded-2xl border border-white/10 bg-slate-900/90 p-6">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="mt-1 font-semibold">Vehicle Opportunity</p>
                    </div>
                  ...
                  <div className="mt-6 rounded-2xl bg-gradient-to-br from-slate-800 to-slate-950 p-6">
                    ...
                    <p className="mt-5 text-xl font-bold">Your Vehicle</p>
                    ...
                    <div className="mt-6 grid grid-cols-2 gap-3">
                      <div className="rounded-xl bg-white/5 p-3">
                        ...
                        <p className="mt-1 text-sm font-medium">Canada</p>
                      </div>
                      <div className="rounded-xl bg-white/5 p-3">
                  ...
                  <div className="mt-5 flex items-center justify-between">
                    <div>
                      <p className="text-xs text-slate-500">Dealer Network</p>
                      <p className="mt-1 font-semibold">Acquisition Opportunity</p>
                    </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-10 lg:grid-cols-[1fr_1.5fr] lg:items-center">
            ...
            <p className="text-lg leading-relaxed text-slate-600">
              ...
              dealership. NorthSky Auto creates a streamlined marketplace where
              vehicle information can reach participating automotive businesses
      ...
      <section className="py-20 sm:py-24">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-[2rem] bg-blue-600 px-8 py-14 text-white sm:px-14 lg:px-16">
            ...
            <div className="relative grid gap-10 lg:grid-cols-[1fr_auto] lg:items-center">
              <div className="max-w-2xl">
                ...
                <p className="mt-5 text-lg leading-relaxed text-blue-100">
                  Submit your vehicle details through NorthSky Auto and connect
                  with participating automotive dealers.
                </p>
              </div>
              <Link
                href="/sell"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-5 text-lg leading-relaxed text-slate-400">
              NorthSky keeps the process simple so sellers can submit information
              and dealers can discover potential inventory.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-10 md:grid-cols-3">
            {[
              ...
              <div key={number} className="border-t border-white/10 pt-8">
              ...
              <div className="rounded-2xl bg-white p-7 shadow-sm">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <h3 className="mt-1 text-xl font-bold">NorthSky Network</h3>
                  </div>
      ...
      <section className="bg-white py-20 sm:py-24">
        <div className="mx-auto max-w-3xl px-6 text-center">
          ...
          <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row">
            ...
            <Link
              href="/dealer"
              className="rounded-xl bg-slate-900 px-7 py-4 font-semibold text-white transition hover:bg-slate-800"
            >
              Join as a Dealer
            </Link>
          </div>
