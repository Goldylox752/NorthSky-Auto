    ...
    >
      {navigation.map((item) => (
        <Link
          ...
          className={
            mobile
              ? "flex shrink-0 items-center gap-2 rounded-lg bg-slate-100 px-3 py-2 text-sm font-bold text-slate-700 transition hover:bg-blue-50 hover:text-blue-700"
              : "group flex items-center gap-3 rounded-xl px-4 py-3 font-semibold text-slate-700 transition hover:bg-blue-50 hover:text-blue-700"
          }
        >
          {!mobile && (
      ...
      <header className="sticky top-0 z-50 border-b border-slate-800 bg-slate-950 text-white">
        <div className="mx-auto flex h-20 max-w-[1600px] items-center justify-between px-4 sm:px-6">
          <Link
            ...
            aria-label="NorthSky Auto Dealer Dashboard"
          >
            <div className="flex h-11 w-11 items-center justify-center rounded-xl bg-blue-600 text-xl font-black shadow-lg shadow-blue-900/30 transition group-hover:bg-blue-500">
              N
            </div>
          ...
          <div className="sticky top-20 p-5">
            ...
            <div className="rounded-2xl bg-gradient-to-br from-blue-600 to-indigo-700 p-5 text-white">
              ...
              <p className="mt-2 text-sm leading-5 text-blue-100">
                Browse available vehicle acquisition opportunities through
                NorthSky Auto.
              </p>
