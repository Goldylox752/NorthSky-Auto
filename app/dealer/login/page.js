            ...
            <section className="hidden bg-gradient-to-br from-blue-700 via-blue-800 to-indigo-950 p-10 text-white lg:flex lg:flex-col lg:justify-between xl:p-14">
              <div>
                ...
                <div className="mt-20">
                  ...
                  <p className="mt-6 max-w-md text-base leading-7 text-blue-100">
                    Sign in to manage opportunities, saved vehicles, and
                    dealership activity.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <Feature
                  ...
                  text="Review seller-submitted vehicles."
                />
                <Feature
                  icon="📊"
                  title="Dealer dashboard"
                  text="Track sourcing in one place."
                />
                <Feature
                  icon="🔒"
                  title="Secure access"
            ...
            <section className="bg-white p-6 text-slate-900 sm:p-10 xl:p-14">
              ...
              <div className="mx-auto max-w-md">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-500">
                  Use your dealer email and password.
                </p>
                ...
                <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className="flex w-full items-center justify-center rounded-xl bg-blue-600 px-5 py-4 text-sm font-black text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700 disabled:cursor-not-allowed disabled:opacity-60"
                  >
                    {loading ? (
                      <>
