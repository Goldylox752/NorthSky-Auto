...
async function getDealer(supabase, user) {
  ...
  /*
   * We support several possible dealer table structures.
   * The first query is the preferred structure.
   */
  ...
  /*
   * If the application uses auth user metadata instead
   * of a dealers table, construct a dealer object from
...
export default async function DealerDashboardPage() {
   ...
   *
   * This query is intentionally defensive because the
   * vehicle table may not exist yet.
   */
  ...
  /*
   * Determine whether the dealer has an active subscription.
   */
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="overflow-hidden rounded-3xl bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 p-8 text-white md:p-10">
            ...
            <div className="flex flex-col gap-8 md:flex-row md:items-center md:justify-between">
              ...
              <div className="shrink-0">
                ...
                <Link
                  href="/dealer/vehicles"
                  className="inline-flex rounded-xl bg-blue-600 px-6 py-4 font-black text-white transition hover:bg-blue-500"
                >
                  Browse Vehicles →
                </Link>
          ...
          <div className="mt-8 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <StatCard
              ...
              value={savedCount}
              description="Vehicles you've saved"
            />
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-3">
            ...
            <div className="lg:col-span-2 rounded-3xl bg-white p-7 shadow-sm ring-1 ring-slate-200">
              ...
              <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Browse vehicles submitted through the
                    NorthSky Auto marketplace.
                  </p>
              ...
              <div className="mt-8 rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-8 text-center">
                ...
                <p className="mx-auto mt-2 max-w-lg text-sm leading-6 text-slate-500">
                  Vehicle opportunities will appear here as
                  sellers submit vehicles and listings become
                  available to participating dealerships.
                </p>

                <Link
                  href="/dealer/vehicles"
                  className="mt-6 inline-flex rounded-xl border border-blue-200 bg-white px-5 py-3 text-sm font-black text-blue-600 transition hover:bg-blue-50"
                >
            ...
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              ...
              <div>
                ...
                <div className="mt-3 flex flex-wrap items-center gap-3">
                  ...
                  <span
                    className={`inline-flex rounded-full px-3 py-1 text-xs font-black ring-1 ${statusClasses(
                      subscriptionStatus
                    )}`}
                  >
                    {formatStatus(
