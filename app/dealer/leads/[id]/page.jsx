...
function StatusBadge({ status }) {
  ...
  return (
    <span className="inline-flex items-center rounded-full bg-green-100 px-4 py-2 text-xs font-black uppercase tracking-wide text-green-700 ring-1 ring-green-200">
...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    openGraph: {
      title: `${vehicleName || "Vehicle Opportunity"} | NorthSky Auto`,
      description:
        "Review a vehicle acquisition opportunity available through NorthSky Auto.",
      url: `${SITE_URL}/dealer/leads/${encodeURIComponent(id)}`,
      type: "website",
    },
  };
}
          ...
          <aside className="space-y-6">
            ...
            <div className="rounded-3xl bg-gradient-to-br from-blue-600 to-indigo-700 p-7 text-white shadow-xl">
              ...
              <p className="mt-4 text-center text-xs leading-5 text-blue-100/80">
                Dealer contact-request functionality will be
                connected to the acquisition workflow next.
              </p>
            </div>
            ...
            <div className="rounded-3xl bg-slate-950 p-7 text-white">
              ...
              <p className="mt-3 text-sm leading-6 text-slate-400">
                Browse additional vehicle opportunities and
                find potential inventory for your dealership.
              </p>
